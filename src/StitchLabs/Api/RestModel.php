...
use StitchLabs\StitchLabsCollection;
...
abstract class RestModel implements ArrayAccess, JsonSerializable {
	 ...
	 * @return self
	 */
	public function __construct(StitchLabs $client)
	{
		$this->client = $client;
	...
	public function all()
	{
		...
		$data = $this->client->restfulRequest('post', $this->getIndexUrl(), ['action'=>'read']);
		$cursor = [];
	...
	{
		return new StitchLabsCollection($array);
	}
